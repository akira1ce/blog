...
createdTime: '2025-08-08 17:27:44'
updatedTime: '2026-06-18 17:35:33'
---
...
tailwind-source.css -> global.css

```json title="package.json"
{
  "scripts": {
    "tw": "tailwindcss -i ./src/tailwind-source.css -o ./src/global.css --watch",
    "tailwind:build": "tailwindcss -i ./src/tailwind-source.css -o ./src/global.css --minify",
    "build": "npm run tailwind:build && cross-env NODE_OPTIONS=--openssl-legacy-provider umi build",
    "dev": "cross-env NODE_OPTIONS=--openssl-legacy-provider TAILWIND_MODE=watch APP_TYPE=site umi dev",
  }
}
```

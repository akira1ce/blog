...
export default async function Page({ params }: Props) {
  ...
  return (
    <>
      ...
      <article className="prose dark:prose-invert prose-h1:text-2xl prose-h2:text-xl prose-h3:text-lg prose-h4:text-base prose-h5:text-sm prose-h6:text-xs mx-auto max-w-4xl py-8">
        <Post />
      </article>
    </>
  );

...
slug: "react-core"
date: 2023-12-05
summary: 探索 React 内部的并发模式、任务调度与更新机制
---
...
requestHostCallback -> schedulePerformWorkUntilDeadline -> 「类似 settimeout(performWorkUntilDeadline, 0)，开启循环」
...
>
> 原内容来自波佬的[useHook-React 面试原理](https://usehook.cn/reactprinciple)，强烈推荐购买阅读。
